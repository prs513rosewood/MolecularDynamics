...
have already encountered a case in Chap. <a href='#x1-10001'>1<!--  tex4ht:ref: chap:introduction   --></a> for which this is not possible: the Coulomb interaction that has the form \(V\left ( r \right ) \propto 1/r\), which decays to 0 too slowly.</p>
<!--  l. 114  -->
...
<!--  l. 136  -->
<p class='noindent'>The sum Eq. \eqref{eq:pairpotcut} runs over all neighbors. One important algorithmic step with complexity \(O(N)\) in molecular dynamics codes is to build a <span class='cmti-12'>neighbor list</span>, i.e. find all pairs <span class='cmti-12'>i-j</span> with \(r_{ij} &lt; r_{c}\). This is usually done using a <span class='cmti-12'>domain</span> <span class='cmti-12'>decomposition</span> (see Fig. <a href='#x1-7001r1'>1.1<!--  tex4ht:ref: fig:neighborsearch   --></a>) that
